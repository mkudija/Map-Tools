...
m.drawmapscale(lon=urcrnrlon-3.25, lat=llcrnrlat+.6, lon0=lon_0, lat0=lat_0, length=200, barstyle='fancy', 
...
for row in range(0,df.shape[0]): 
    ...
    logo = read_png('data/airport1.png')
    ...
    ranges = [200] # in nautical miles, add other distances to list as desired
    for range in ranges:
